...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jjc6loy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jjc6loy.containers.anotherwebservice.com/
...
```
git clone git@github.com:mehdi12345678910/container-jjc6loy.git
cd container-jjc6loy
```
...
```
docker attach container-jjc6loy
```
